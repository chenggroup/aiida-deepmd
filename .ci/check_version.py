...
Check version number in setup.json and aiida_deepmd/__init__.py and make sure
they match.
"""
...
import aiida_deepmd  # pylint: disable=wrong-import-position
version = aiida_deepmd.__version__
